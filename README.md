...
The default detection hold is 30 seconds and can be changed in Settings. This keeps one clip/session open when YOLO briefly loses a subject that is still in frame.
